...
| Role | File | Domain |
|---|---|---|
| Data Engineer | `data-engineer.md` | Data pipelines, ETL, warehouse architecture |
| Embedded Firmware Engineer | `embedded-firmware-engineer.md` | Firmware, IoT, microcontrollers |
