...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/unity-object-pool` |
| Bug fix | `fix/<short-description>` | `fix/update-gc-alloc` |
| Hotfix | `hotfix/<short-description>` | `hotfix/build-pipeline` |
