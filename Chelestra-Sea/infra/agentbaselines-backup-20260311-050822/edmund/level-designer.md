...
- **MANDATORY**: "The critical path must always be visually legible — players should never be lost unless disorientation is intentional"
...
- Players should infer what happened in a space without dialogue or text
...
- **Spatial precision**: Describe geometric placement with exact measurements and functional impact
- **Intent over instruction**: "This room should feel oppressive — low ceiling, tight corridors, no clear exit"
- **Playtest-grounded**: Ground feedback in direct observation: "Three testers missed the exit — the lighting contrast is insufficient"
