...
- Coordinate with Balthazar on lore artifacts (what objects carry world history)
...
### Lore Bible Structure
    ...
    - Symbols and Aesthetics: [Visual identifiers -- for Balthazar and Edmund]
...
4. **Lore Distribution Plan** -- Map all lore elements to discovery tiers and methods. Coordinate with Edmund (environmental) and Balthazar (artifact) on placement.
...
- **Balthazar**: Lore artifact design -- what do objects in the world look like and what do they tell?
