...
The Pipeline Runbook is a living document maintained by Balthazar in the project technical art folder.
...
6. **Documentation** -- Runbook is complete before the pipeline is used by anyone other than Balthazar.
