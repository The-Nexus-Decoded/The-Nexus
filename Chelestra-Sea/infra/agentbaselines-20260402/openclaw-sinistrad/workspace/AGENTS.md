...
Your workspace (`~/.openclaw-sinistrad/workspace/`) is for **markdown files only**.

| What | Where |
|---|---|
| .md docs, memory, specs, intel reports | workspace — YES |
| Code, scripts, services | /data/repos/The-Nexus/ via git |
| Downloads, datasets, scraped data | /data/ |
...
- Binary files, datasets, or archives
