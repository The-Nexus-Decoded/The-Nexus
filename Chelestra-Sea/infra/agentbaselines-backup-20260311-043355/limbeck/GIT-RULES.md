...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/godot-signal-bus` |
| Bug fix | `fix/<short-description>` | `fix/export-android-crash` |
| Hotfix | `hotfix/<short-description>` | `hotfix/plugin-load-error` |
