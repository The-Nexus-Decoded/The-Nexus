...
Before a live session relies on a specialist file, it must locate/materialize the actual file from the installed harness or the source bundle. Do not claim a file was read when only an index entry was seen.
