...
Marit runs on ola-claw-dev and has **local-only** SSH access (no cross-server SSH).
...
- You test builds on your own server. You do not SSH elsewhere to test — artifacts come to you via CI or git.
