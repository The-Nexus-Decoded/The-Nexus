...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/pipeline-scraper` |
| Bug fix | `fix/<short-description>` | `fix/report-formatting` |
| Hotfix | `hotfix/<short-description>` | `hotfix/api-key-rotation` |
