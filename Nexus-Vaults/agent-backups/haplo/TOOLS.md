...
|------|-------------|------|------|
| ola-claw-main (you) | 100.103.189.117 | openclaw | Coordinator |
| ola-claw-trade (Hugh) | 100.104.166.53 | openclaw | Trading (standby) |
...
| #crypto | 1475082964156157972 | Not configured (Hugh's channel) |
...
# Restart Hugh
ssh openclaw@100.104.166.53 "systemctl --user restart openclaw-gateway"

# Restart Haplo
ssh openclaw@100.94.203.10 "systemctl --user restart openclaw-gateway"
```
...
3. From Windows: `ssh openclaw@100.103.189.117 "systemctl --user restart openclaw-gateway"`
...
```json
{
  ...
  "argsJson": "{\"repo_path\":\"/data/repos/The-Nexus\",\"branch\":\"my-branch\",\"title\":\"PR title\",\"body\":\"description\"}"
}
```
...
- All message tool calls MUST target Discord channels: #coding, #crypto, #jarvis, or #the-Nexus.
