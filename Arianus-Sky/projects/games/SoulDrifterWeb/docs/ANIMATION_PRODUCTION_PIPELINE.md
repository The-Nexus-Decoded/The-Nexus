...
13. **Every humanoid enters animation through the dual-pose and Smart Mesh gate.** Tripo bodies use Smart Mesh P1.0 with accepted Quad Face topology before PBR texturing or rigging. The canonical rig preserves a strict T-pose calibration artifact and derives a relaxed A-pose validation artifact from the same mesh and skeleton. Neither the provider label nor one attractive pose waives joint-loop, skin-weight, equipment-fit, or continuous-deformation proof.
