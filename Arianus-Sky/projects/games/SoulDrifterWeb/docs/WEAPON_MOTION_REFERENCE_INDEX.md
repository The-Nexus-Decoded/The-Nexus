...
Current source-motion implementation: Mixamo `Stable Sword Outward Slash`, acquired on the exact Elf Shadowknight rig at 30 FPS with no keyframe reduction and preserved at source SHA-256 `38589E534D2C47F5F095BC08CDA0C4853607D3BB86F8EDABFC5802F9C3BF0DE9`. The unchanged FBX-to-GLB animation pack is `public/assets/3d/animations/elf-shadowknight/siphon-cleave-baseline.glb` (SHA-256 `77C91BD70CD06D6B8BF452E0C66BF8A0B6CA200B21957B7E7A2A3ABC23C60BC5`). Runtime binding preserves all 195 skeletal tracks, anchors only top-level armature X/Z travel, slices the original `[15,31)` source-frame envelope without resampling, plays it at `0.47`, resolves contact at output phase `0.88`, and crossfades back to `IdleRelaxed`. It is the semantic `SiphonCleaveBaseline` for both player and compatible NPC/class actors; it is not merged or pose-reconstructed in the character GLB. The separately acquired Mixamo `One Hand Sword Combo` (SHA-256 `9F933921AE56053D54ADBAE1D2CF0E3CF1F9552B6989C45C1521D6A8706FE0B2`) remains unbound and reserved for a future advanced multi-hit skill; it is explicitly forbidden as Weapon Strike or beginner Siphon Cleave.
