...
The rejected paid Warden remains provenance only. Its replacement source set now combines corrected front v2, exact left profile v3, true rear v2, and exact right profile v3. The front proves the single sensor mask, front-only furnace cavity, left soul-tax palm, and right integrated blade; the rear proves a solid head shell, segmented mechanical spine, and two heat vents with no second face or core; the side elevations collapse the front furnace to edge thickness and preserve the asymmetric near/far arms. All four 1122x1402 sources passed the contradiction gate. The Meshy conversion remains intentionally unsubmitted because it would cross the owner-set 800-credit hard floor.
