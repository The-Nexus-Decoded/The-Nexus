...
The authoritative browser-specific direction is in [`docs/BROWSER_GAME_DESIGN.md`](docs/BROWSER_GAME_DESIGN.md). Character and living-story rules are in [`docs/CHARACTER_AND_STORY_SYSTEM.md`](docs/CHARACTER_AND_STORY_SYSTEM.md), and class/rune progression is in [`docs/CLASS_PROGRESSION_CODEX.md`](docs/CLASS_PROGRESSION_CODEX.md). The full inherited world and content canon is preserved in [`docs/GAME_BIBLE.md`](docs/GAME_BIBLE.md).
