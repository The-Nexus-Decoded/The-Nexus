...
const wood = [.235,.137,.326,.199], iron = [.65,.040,.70,.052];
...
const receipt={...encoded.receipt,sourceTextures:'original embedded 2K; bytes unchanged',sourceLicense:'existing project source; original account receipt not independently recovered',
  seam:.122,lidPivot,haspPivot,interiorAperture:aperture,woodUv:wood,ironUv:iron,poses:[]};
for(const [name,lidDegrees,haspDegrees] of poses) {
  ...
  const config={static:true,candidatePath:file,candidateSha256:sha,runtimeScale:1,fixedFloorMeters:-.29840388894081116,clips:[
    {name:'Front',duration:0,keyTimes:[0],closeFocus:[0,0,.05],closeScale:1.65,closeOffset:[2.5,0,.25]},
    {name:'Interior',duration:0,keyTimes:[0],closeFocus:[0,0,.05],closeScale:1.65,closeOffset:[2.5,-2.5,2.5]},
    {name:'Back',duration:0,keyTimes:[0],closeFocus:[0,0,.05],closeScale:1.65,closeOffset:[-2.5,0,1.5]},
    {name:'Side',duration:0,keyTimes:[0],closeFocus:[0,0,.05],closeScale:1.65,closeOffset:[0,-2.5,.5]},
  ]};
