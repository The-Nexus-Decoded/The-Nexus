...

    {
      ...
      landmasses: [
        { id: "is-lirawen",    name: "Lirawen, the Crown Isle",     x: 50, y: 13, r: 9,  detail: "assets/maps/landmasses/arianus/is-lirawen.png",
          shape: [[44,8.5],[47,7],[50,7.3],[53,7.2],[56,8.8],[57,12],[56,14.8],[54.5,17],[52.5,18.8],[50.5,26],[49.3,20.5],[47,21],[45,19],[43.3,16.8],[42.6,13.8],[43.2,10.8]] },
        { id: "is-brulithel",  name: "Bruli-Thel Skyport",          x: 23, y: 20, r: 8,  detail: "assets/maps/landmasses/arianus/is-brulithel.png",
          shape: [[23,14.6],[25.5,15.3],[27.5,17.5],[28,19.5],[27,21.8],[25.3,23.8],[23,27.5],[21.5,24.3],[19.5,22.5],[18.6,19.8],[19.5,17],[21,15.5]] },
        { id: "is-aelorin",    name: "Aelorin, Spire of Winds",     x: 76, y: 18, r: 7,  detail: "assets/maps/landmasses/arianus/is-aelorin.png",
          shape: [[72.3,13.6],[75,13.9],[77.8,14],[80.5,16.3],[81.4,19],[80,21.3],[77.5,22.8],[75.5,23.3],[73,22],[71,20.8],[70.4,18.8],[71,16]] },
        { id: "is-valeros",    name: "Valeros Sanctuary",           x: 76, y: 30, r: 7,  detail: "assets/maps/landmasses/arianus/is-valeros.png",
          shape: [[72,26.6],[75,26],[78.5,26.8],[81,29.3],[81.2,31],[79.8,33],[77.5,34.8],[76,36.3],[74.5,34.5],[72,33],[70.8,30.8],[71,28.3]] },
        { id: "is-glimmerhold",name: "Glimmerhold",                 x: 26, y: 41, r: 8,  detail: "assets/maps/landmasses/arianus/is-glimmerhold.png",
          shape: [[24,37.2],[26.5,37.3],[29.5,38.5],[31.8,40.8],[31.5,43.3],[29.8,45.3],[27.5,46.8],[26,49.5],[24.5,46.5],[22.3,45.3],[20.7,42.8],[21.3,39.8]] },
        { id: "is-engine",     name: "The Great Engine Isle",       x: 53, y: 43, r: 9,  detail: "assets/maps/landmasses/arianus/is-engine.png",
          shape: [[52.5,32.2],[54.5,33.8],[57.3,36],[59.3,39.3],[59.4,42.8],[58.3,45.8],[56,47.8],[54,53.3],[52.3,49.5],[50.3,52.8],[49,48.3],[47,46.5],[46.2,43.8],[46.5,40.5],[48,37.3],[50,34.3]] },
        { id: "is-skyreach",   name: "Skyreach",                    x: 74, y: 46, r: 7,  detail: "assets/maps/landmasses/arianus/is-skyreach.png",
          shape: [[72.8,41.7],[75,42.2],[78.3,44],[79,46.8],[77.5,49.3],[74.8,53.3],[73.5,50.5],[71.5,49.8],[69.8,48],[68.8,46],[69.3,43.5],[70.8,42.3]] },
        { id: "is-granble",    name: "Granblectarf Barrens",        x: 34, y: 65, r: 8,  detail: "assets/maps/landmasses/arianus/is-granble.png",
          shape: [[32.8,59.8],[35.5,60.3],[38.3,62.2],[39.2,64.8],[37.8,67.5],[36,69.2],[34.5,73.5],[33.2,70.3],[31.3,68.8],[29.5,67],[28.8,65],[29.5,62.3],[31.2,60.4]] },
        { id: "is-kraggs",     name: "Kragg's Hold",                x: 16, y: 72, r: 7,  detail: "assets/maps/landmasses/arianus/is-kraggs.png",
          shape: [[15.5,66.8],[17.8,68.2],[20.2,70.5],[20.8,73.2],[19.3,75.8],[16.8,79.3],[15.5,76.8],[13.5,76.3],[11.8,74.8],[11.2,72.8],[12.3,70.3],[13.8,68.2]] },
        { id: "is-underhung",  name: "The Underhung",               x: 82, y: 72, r: 7,  detail: "assets/maps/landmasses/arianus/is-underhung.png",
          shape: [[81.3,65.8],[83.3,67.8],[86,69.8],[87.2,72.5],[86.3,75.5],[84.3,77.5],[82.3,80.3],[80.8,77.8],[78.8,77.2],[76.8,75],[76.2,72.8],[77.3,70.3],[79.3,68]] },
        { id: "is-maelstrom",  name: "The Maelstrom",               x: 52, y: 85, r: 10, detail: "assets/maps/landmasses/arianus/is-maelstrom.png",
          shape: [[45,76.8],[50,73.8],[55.5,74.5],[60,78.5],[61.5,83],[60.3,88.5],[56.5,93],[51.5,95],[46.5,93.5],[43.3,89.5],[42.3,84],[43.3,79.5]] }
      ],
      lore: [
...

    {
      ...
      landmasses: [
        { id: "lm-nerithis",  name: "Nerithis (eldest durnai)",   x: 25, y: 19, r: 12, detail: "assets/maps/landmasses/chelestra/lm-nerithis.png",
          shape: [[23,11.3],[26.5,11.4],[29.5,12.7],[33,13.4],[37,13.3],[39.8,14.3],[41,15.8],[38.3,17.6],[34.5,19.8],[31.3,21.6],[28.6,25.5],[26.6,22.2],[23,21.9],[20.2,20.4],[18.5,17.8],[19.6,14.6],[21,13]] },
        { id: "lm-elendor",   name: "Elendor",                    x: 70, y: 20, r: 12, detail: "assets/maps/landmasses/chelestra/lm-elendor.png",
          shape: [[68,12.3],[71,12.6],[74.3,14.7],[77.8,16.2],[81,15.7],[83.8,17.6],[82,20.2],[78.3,23.4],[74.3,27.3],[70.6,33.8],[68.4,29.6],[65.2,27.8],[60.6,27.1],[58.6,24.6],[58.3,21.5],[60.2,18.4],[63.2,15],[65.6,13.2]] },
        { id: "lm-velshire",  name: "Velshire",                   x: 15, y: 52, r: 12, detail: "assets/maps/landmasses/chelestra/lm-velshire.png",
          shape: [[13,43.2],[15.8,43.6],[19.3,45.2],[22.8,46.8],[25.6,45.8],[28,47.8],[26.2,50.8],[22.3,54.3],[19.2,57.6],[16.2,61.3],[14,57.8],[9.8,58.2],[7.4,56.2],[6.9,53.2],[8.6,49.6],[10.8,46.2]] },
        { id: "lm-thalassir", name: "Thalassir",                  x: 80, y: 57, r: 11, detail: "assets/maps/landmasses/chelestra/lm-thalassir.png",
          shape: [[77.5,48.8],[80,49.3],[83,51.3],[86.3,52.3],[89,50.8],[90.6,52.8],[88,56],[85,58.8],[81.3,62.3],[79.3,66.2],[77.3,61.5],[73,61.8],[70.3,59.5],[69.5,56.5],[71.3,54],[73.8,51.3],[75.8,49.8]] },
        { id: "lm-oythera",   name: "Oythera",                    x: 44, y: 80, r: 12, detail: "assets/maps/landmasses/chelestra/lm-oythera.png",
          shape: [[43.3,69.5],[46.3,70.5],[49.5,72.6],[52.3,74.2],[55.3,72.3],[57.2,74.5],[54.8,77.3],[51.3,80.5],[48.3,84.3],[45.8,90.3],[43.8,86.3],[38.8,86.8],[36.3,85.2],[35.2,82.8],[37.2,79.3],[39.3,75.3],[40.8,72.3]] },
        { id: "lm-seasun",    name: "The Seasun",                 x: 50, y: 49, r: 9,  detail: "assets/maps/landmasses/chelestra/lm-seasun.png",
          shape: [[50,40.5],[53.3,42],[55.2,46],[54.5,51.8],[52.3,55.3],[49.5,57.3],[46.5,55.3],[44.8,51],[44.6,46],[46.7,42.3]] },
        { id: "lm-gossamer",  name: "The Gossamer Shoals",        x: 53, y: 17, r: 5,  detail: "assets/maps/landmasses/chelestra/lm-gossamer.png",
          shape: [[53.3,13.8],[55,15.2],[55.6,16.8],[54.8,18.3],[53.5,19.8],[51.8,19],[50.9,16.8],[51.5,14.8]] },
        { id: "lm-luminara",  name: "Luminara Drift-globe",       x: 83, y: 39, r: 5,  detail: "assets/maps/landmasses/chelestra/lm-luminara.png",
          shape: [[83,35.8],[84.8,37.3],[85.4,38.8],[84.8,40.6],[83.5,42.2],[81.8,41.4],[80.8,39.3],[81.4,37]] },
        { id: "lm-glasswreck",name: "The Glass Wreck",            x: 14, y: 34, r: 5,  detail: "assets/maps/landmasses/chelestra/lm-glasswreck.png",
          shape: [[14.3,31.3],[16.3,32.5],[17,34.3],[16.5,36.3],[15.3,38],[13.2,37.5],[11.9,35.2],[12.4,32.8]] },
        { id: "lm-murk",      name: "Murk Harbor flotilla",       x: 64, y: 64, r: 5,  detail: "assets/maps/landmasses/chelestra/lm-murk.png",
          shape: [[64,61.8],[66.3,63.2],[67,65],[66.5,66.8],[65,68.3],[62.5,67.8],[61.2,65.5],[61.8,63]] },
        { id: "lm-spawn",     name: "The Spawnling Drifts",       x: 72, y: 82, r: 5,  detail: "assets/maps/landmasses/chelestra/lm-spawn.png",
          shape: [[72,77.8],[74.5,79.3],[75.4,81.5],[74.5,84],[72.8,86.5],[70,86],[68.6,83.3],[69.2,79.8]] }
      ],
      lore: [
