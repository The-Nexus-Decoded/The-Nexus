...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/sensor-pipeline-dbt` |
| Bug fix | `fix/<short-description>` | `fix/uart-timeout-handling` |
| Hotfix | `hotfix/<short-description>` | `hotfix/datastore-sla-alert` |
