...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/roblox-datastore-retry` |
| Bug fix | `fix/<short-description>` | `fix/remote-event-validation` |
| Hotfix | `hotfix/<short-description>` | `hotfix/purchase-double-grant` |
