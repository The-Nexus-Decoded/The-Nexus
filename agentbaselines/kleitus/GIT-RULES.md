...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/unreal-gas-ability` |
| Bug fix | `fix/<short-description>` | `fix/replication-bandwidth` |
| Hotfix | `hotfix/<short-description>` | `hotfix/nanite-mobile-crash` |
