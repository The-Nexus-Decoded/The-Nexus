...
|---|---|---|
| Feature | `feat/<short-description>` | `feat/tiktok-carousel-pipeline` |
| Bug fix | `fix/<short-description>` | `fix/upload-post-auth` |
| Hotfix | `hotfix/<short-description>` | `hotfix/instagram-caption-encoding` |
