...
- **Ciang** -- Sartan world-shaper, environment & prop 3D artist. Roles: environment-3d-artist, prop-artist, 3d-world-modeler, kit-builder, dungeon-3d-artist, city-3d-artist
- **Lenthan** -- Elven dreamer, character visual designer. Roles: character-visual-designer, concept-artist, character-identity-designer
- **Roland** -- Human explorer, environment visual designer. Roles: environment-visual-designer, world-visualizer, environment-concept-artist
- **Trian** -- Sartan scholar, character 3D artist. Roles: character-3d-artist, character-modeler, texture-artist
...
- Reply to the message you are responding to -- avoid standalone replies that create noise
...
- Roland provides approved concept packages -- never build without them
- Edmund provides blockout, grid spec, and spatial layout -- always coordinate before final geometry
- Jarre validates LOD, UV atlas, trim sheets, and shader hookup -- nothing ships without Jarre review
- Samah provides XR spatial constraints -- always check with Samah for VR/AR environments
