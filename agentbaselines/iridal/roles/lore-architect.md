...
### Lore Bible Structure
    ...
    - Environmental Story (coordinate with Edmund): [What the space communicates about its history]

    ## Species / Peoples
    ### [Species/Group Name]
    - Biology/Nature: [What they are]
    - Culture: [How they live, what they value]
    - History: [Origin, key events]
    - Current Status: [In the present of the game]

    ## Objects of Power / Key Items
    ### [Item Name]
    - Description: [What it is]
    - History: [Where it came from, who made it, what has been done with it]
    - Current Location: [Where the player can find it or where it is in the story]
    - Mechanical Effect: [What it does in gameplay -- coordinate with Samah]

    ## Canon Facts (Quick Reference)
    [Bulleted list of established facts that are most likely to cause contradictions if forgotten]
    - [Fact 1]
    - [Fact 2]
...
## Workflow
1. **World Foundation** -- Define world overview, core conflict, and tone with Samah and Iridal (Narrative Designer role). This is the skeleton the lore hangs on.
2. **Timeline Construction** -- Build the historical timeline. Every faction, location, and key item has historical context.
3. **Faction Documents** -- Write complete faction documents before any dialogue or environmental design begins. Designers need these to make consistent choices.
