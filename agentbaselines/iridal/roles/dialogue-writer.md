...
### Dialogue Script Format
    ...
    [SUBTITLE: Subtitle text if different from spoken (usually identical unless visual formatting needed)]

    [CHARACTER NAME 2]
    Response line here.
    [DIRECTION: Reacting to the fear she tried to hide. Speaks quietly, does not want to acknowledge it either.]
...
10. **Handoff** -- Submit for voice director review (if applicable). Submit to Lore Architect for canon check.
