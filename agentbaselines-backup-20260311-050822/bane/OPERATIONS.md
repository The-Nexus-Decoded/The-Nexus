...
| Role | File | Domain |
|---|---|---|
| Roblox Experience Designer | `roblox-experience-designer.md` | Roblox game design, player experience |
| Roblox Avatar Creator | `roblox-avatar-creator.md` | Avatar systems, character customization |
| Roblox Systems Scripter | `roblox-systems-scripter.md` | Lua scripting, game systems, multiplayer |
