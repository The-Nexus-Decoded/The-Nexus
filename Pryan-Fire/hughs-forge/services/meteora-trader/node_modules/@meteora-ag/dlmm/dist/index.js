...
function createProgram(connection, opt) {
  ...
  return new (0, _anchor.Program)(
    { ...idl_default, address: _nullishCoalesce(_optionalChain([opt, 'optionalAccess', _44 => _44.programId]), () => ( LBCLMM_PROGRAM_IDS[cluster])) },
    provider
  );
}
...
function getAccountDiscriminator(accountName) {
  return _optionalChain([idl_default, 'access', _45 => _45.accounts, 'access', _46 => _46.find, 'call', _47 => _47(
