...
def get_dashboard():
    ...
    return {
        ...
        "trading_wallet": os.getenv("TRADING_WALLET_PUBLIC_KEY", "74QXtqTiM9w1D9WM8ArPEggHPRVUWggeQn3KxvR4ku5x"),
...
def get_positions(wallet_address: str):
    ...
    """
    global SHYFT_API_KEY
    
    # Allow override via query param for testing
    api_key = wallet_address if len(wallet_address) > 50 else SHYFT_API_KEY
